def build_model_split(arch='lenet5', dtype='mnist', alg='base', split=2):
    ...
    '''
    map_dtype_numclass = {'mnist': 10, 'fashionmnist': 10, 'cifar10': 10, 'cifar100': 100}
...
def build_model(arch='lenet5', dtype='mnist', alg='base'):
    ...
    map_dtype_numclass = {'mnist': 10, 'cifar10': 10, 'cifar100': 100, 'test': 4}
    num_classes = map_dtype_numclass[dtype]
    ...
    if arch == 'lenet5':
        ...
        model = VGG(dtype=dtype,  num_classes=num_classes)
