...
class FileNameCurve():
    ...
    def __init__(self, args):
        self.args = args
        # mnist, fashionmnist b = 100
        # self.best_fl_lr = { 'mnist':        { 0: 0.05, 10.0: 0.05, 5.0: 0.05}, 
        #                     'fashionmnist': { 0: 0.05, 10.0: 0.05, 5.0: 0.05}, 
        #                     'cifar10':      { 0: 0.05, 10.0: 0.05, 5.0: 0.05} }
        # self.best_sl_lr = { 'mnist':        { 0: 5e-3, 10.0: 0.01, 5.0: 5e-3}, 
        #                     'fashionmnist': { 0: 0.01, 10.0: 0.01, 5.0: 5e-3}, 
        #                     'cifar10':      { 0: 0.01, 10.0: 0.01, 5.0: 0.01} }
        
        # mnist, fashionmnist b = 1000
        self.best_fl_lr = { 'mnist':        { 0: 0.1, 10.0: 0.05, 5.0: 0.1, 1.0: 0.05}, 
                            'fashionmnist': { 0: 0.1, 10.0: 0.1, 5.0: 0.1, 1.0: 0.1}, 
                            'cifar10':      { 0: 0.05, 10.0: 0.1, 5.0: 0.1} }
        self.best_sl_lr = { 'mnist':        { 0: 0.01, 10.0: 5e-3, 5.0: 0.01, 1.0: 0.01}, 
                            'fashionmnist': { 0: 0.1, 10.0: 0.1, 5.0: 0.1, 1.0: 0.01}, 
                            'cifar10':      { 0: 0.01, 10.0: 0.01, 5.0: 0.01} }
        if unbalanced == 1:
    ...
    def select_files(self):
        ...
        for d in self.args.dist:
            dist = dist_dict[d]
            lr = self.best_fl_lr[self.args.d][d]
        ...
        for d in self.args.dist:
            dist = dist_dict[d]
            lr = self.best_sl_lr[self.args.d][d]
...
# python cmp_noniid_best.py -x "round" -d cifar10 --dist 10.0 --clients 10 -b 100 -t 3 --slr 0.005 --fl 0
...
def plotcurve(args):
    ...
    # if args.d == 'mnist' or args.d == 'fashionmnist':
    #     plt.ylim(ymin=20)
    # elif args.d == 'cifar10':
    #     plt.ylim(ymin=30)
    #plt.ylim(ymin=60)
    ...
    plt.legend(lines, loc=4, ncol= ncol, prop={'size': 14}) # loc = 1 or 4
    plt.grid()
