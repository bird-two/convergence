...
mnist_temps = [
    ...
    'base fl({} 1 1.0) lenet5 {}(dir-u 10.0) {}{} hp({})', 'base sl({} 1 1.0) lenet5(2) {}(dir-u 10.0) {}{} hp({})',
    'base fl({} 1 1.0) lenet5 {}(dir-u 5.0) {}{} hp({})', 'base sl({} 1 1.0) lenet5(2) {}(dir-u 5.0) {}{} hp({})',
    'base fl({} 1 1.0) lenet5 {}(dir-u 1.0) {}{} hp({})', 'base sl({} 1 1.0) lenet5(2) {}(dir-u 1.0) {}{} hp({})',
    'base fl({} 1 1.0) lenet5 {}(dir-u 0.5) {}{} hp({})', 'base sl({} 1 1.0) lenet5(2) {}(dir-u 0.5) {}{} hp({})',
    'base fl({} 1 1.0) lenet5 {}(pat2-b 8.0) {}{} hp({})', 'base sl({} 1 1.0) lenet5(2) {}(pat2-b 8.0) {}{} hp({})',
...
cifar10_temps = [
    ...
    'base flv2({} 1 1.0) vgg11 {}(dir-u 10.0) {}{} hp({})', 'base sl({} 1 1.0) vgg11(4) {}(dir-u 10.0) {}{} hp({})',
    'base flv2({} 1 1.0) vgg11 {}(dir-u 5.0) {}{} hp({})', 'base sl({} 1 1.0) vgg11(4) {}(dir-u 5.0) {}{} hp({})',
    'base flv2({} 1 1.0) vgg11 {}(dir-u 1.0) {}{} hp({})', 'base sl({} 1 1.0) vgg11(4) {}(dir-u 1.0) {}{} hp({})',
    'base flv2({} 1 1.0) vgg11 {}(dir-u 0.5) {}{} hp({})', 'base sl({} 1 1.0) vgg11(4) {}(dir-u 0.5) {}{} hp({})',
    'base flv2({} 1 1.0) vgg11 {}(pat2-b 8.0) {}{} hp({})', 'base sl({} 1 1.0) vgg11(4) {}(pat2-b 8.0) {}{} hp({})',
...
# python avg_test_acc.py --alg sgd -d fashionmnist --clients 10 -b 10
...
class HeatMapData():
    def __init__(self, args):
        ...
        select_epochs_dict = {50:10, 400:40, 20:2, 10:1}
        ...
        self.llr_choice = [0.0001, 0.0005, 0.001, 0.005, 0.01, 0.05, 0.1]
        #self.col_ticks = [1e-5, 5e-5, 0.0001, 0.0005, 0.001, 0.005, 0.01, 0.05, 0.1]
        self.col_ticks = ['f(-4)','5f(-4)','f(-3)','5f(-3)','f(-2)','5f(-2)','f(-1)']
    ...
    def print_data2(self):
        if self.dataset == 'mnist':
            a = ['L-M &{} &IID &{} &{}'.format(self.args.clients, self.args.alg, self.args.b), 
                 'L-M &{} &10.0$^\star$ &{} &{}'.format(self.args.clients, self.args.alg, self.args.b),
                 'L-M &{} &5.0$^\star$ &{} &{}'.format(self.args.clients, self.args.alg, self.args.b),
                 'L-M &{} &1.0$^\star$ &{} &{}'.format(self.args.clients, self.args.alg, self.args.b),
                 'L-M &{} &0.5$^\star$ &{} &{}'.format(self.args.clients, self.args.alg, self.args.b),
                 'L-M &{} &8 &{} &{}'.format(self.args.clients, self.args.alg, self.args.b), 
            ...
            a = ['L-F &{} &IID &{} &{}'.format(self.args.clients, self.args.alg, self.args.b), 
                 'L-F &{} &10.0$^\star$ &{} &{}'.format(self.args.clients, self.args.alg, self.args.b),
                 'L-F &{} &5.0$^\star$ &{} &{}'.format(self.args.clients, self.args.alg, self.args.b),
                 'L-F &{} &1.0$^\star$ &{} &{}'.format(self.args.clients, self.args.alg, self.args.b),
                 'L-F &{} &0.5$^\star$ &{} &{}'.format(self.args.clients, self.args.alg, self.args.b),
                 'L-F &{} &8 &{} &{}'.format(self.args.clients, self.args.alg, self.args.b), 
            ...
            a = ['V-10 &{} &IID &{} &{}'.format(self.args.clients, self.args.alg, self.args.b), 
                 'V-10 &{} &10.0$^\star$ &{} &{}'.format(self.args.clients, self.args.alg, self.args.b),
                 'V-10 &{} &5.0$^\star$ &{} &{}'.format(self.args.clients, self.args.alg, self.args.b),
                 'V-10 &{} &1.0$^\star$ &{} &{}'.format(self.args.clients, self.args.alg, self.args.b),
                 'V-10 &{} &0.5$^\star$ &{} &{}'.format(self.args.clients, self.args.alg, self.args.b),
                 'V-10 &{} &8 &{} &{}'.format(self.args.clients, self.args.alg, self.args.b), 
            ...
            a = ['V-100 &{} &IID &{} &{}'.format(self.args.clients, self.args.alg, self.args.b), 
                 'V-100 &{} &8 &{} &{}'.format(self.args.clients, self.args.alg, self.args.b), 
        ...
        for i in range(len(self.temps)//2):
            ...
            if self.dataset == 'cifar100':
                ...
                min0 = np.where((self.data_point_map[2*i+0]>0.0)&(self.data_point_map[2*i+0]<10.1))[0]
                min1 = np.where((self.data_point_map[2*i+1]>0.0)&(self.data_point_map[2*i+1]<10.1))[0]
            else:
...
def gen_heatmap(heatmapdata):
    ...
    row_ticks = ['FL(iid)', 'SL(iid)', 'FL($\\alpha=10.0$)', 'SL($\\alpha=10.0$)', 'FL($\\alpha=5.0$)', 'SL($\\alpha=5.0$)', 'FL($\\alpha=1.0$)', 'SL($\\alpha=1.0$)','FL($\\alpha=0.5$)', 'SL($\\alpha=0.5$)', 
                 'FL(8)', 'SL(8)', 'FL(5)', 'SL(5)', 'FL(2)', 'SL(2)']
