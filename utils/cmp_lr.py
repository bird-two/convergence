...
class FileNameCurve():
    ...
    def select_files(self):
        ...
        dist_dict = { 0:'iid-b', 1:'(pat2-b 1.0)', 2:'(pat2-b 2.0)', 5:'(pat2-b 5.0)' }
        if self.args.d == 'cifar10':
...
parser.add_argument('-f', type=int, default=1, help='Use FL or not')
...
print(args)
# python cmp_lr.py -d fashionmnist --dist 1 --clients 10 -t 3 -x "round" --lr 
